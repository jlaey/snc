...
<li><a href="categorylist.php" class="active">Ingredient List</a></li>
...
<h4>Product Ingridients list</h4>
<h6>View/Search Ingridients</h6>
</div>
</div>
...
<div class="table-responsive">
        <table class="table datanew">
            ...
            <tbody>
                ...
                // Using SQL to fetch ingredient data
                $sql = "SELECT * FROM ingredients";
                $result = mysqli_query($con, $sql);

                // Loop through the ingredient data and display it
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td><label class='checkboxs'><input type='checkbox'><span class='checkmarks'></span></label></td>";
                    echo "<td>" . $row['i_name'] . "</td>";
                    echo "<td>" . $row['i_amount'] . "</td>";
                    // Replace 'i_description' with the correct column name
